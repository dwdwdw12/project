...
public class MailSendServiceTest {
	...
	public void updateMailKeyTest() throws Exception{
		...
		sendMail.setSubject(" 항공 인증 메일입니다.");
		sendMail.setText("<h3> 항공을 찾아주셔서 감사합니다.</h3>" +
						"<br>아래 확인 버튼을 눌러서 인증을 완료해 주시기 바랍니다." +
						"<br><br><a href='http://43.203.77.138:8081/join/getUserId"
						+"?email="+email+
						"&mail_key="+mail_key
						+"' target='_blank'>이메일 인증 확인</a>");
		sendMail.setFrom("systemlocal99@gmail.com", " 항공");
