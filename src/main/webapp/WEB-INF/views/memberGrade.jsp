...
<body>
<button type="button" class="button" id="gradeInformation" name="gradeInformation">회원등급안내</button>
<button type="button" class="button" id="gradeBenefit" name="gradeBenefit">회원혜택안내</button>
<hr>
	...
	<div class="gradeInformation">
		...
		<c:if test="${!empty loginUser}">
			...
			<c:if test="${loginUser.gradeCode == 2}">
				<strong style="color:#FFC107;">무지</strong> 입니다.
			</c:if>
			<c:if test="${loginUser.gradeCode == 1}">
				<strong style="color:#FEC6C7;">어피치</strong> 입니다.
			</c:if>
		...
		<section class="grade">
				...
				<span>
					...
					가입일로부터 <br>다음의 어느 한 조건을 충족할 경우<br><br>
					1) 100만 탑승 마일 적립<br>
					2) 카카오항공 1,000회 탑승
				</span>
				</div>
				...
				<hr>
				<span>
					‘기준일’로부터 매 24개월간 <br>다음의 어느 한 조건을 충족할 경우<br><br>
					1) 50만 탑승 마일 적립<br>
					2) 카카오항공 50회 탑승<br>
					3) 탑승 마일이 50만 마일 이상이면서 카카오 <br>제휴카드 이용 실적과 합하여 50만 마일 적립
				</span>
				</div>
				...
				<span>
					...
					1) 30만 탑승 마일 적립<br>
					2) 카카오항공 50회 탑승<br>
					3) 탑승 마일이 30만 마일 이상이면서 카카오 <br>제휴카드 이용 실적과 합하여 30만 마일 적립
				</span>
				</div>
	...
	<div class="gradeBenefit" style="display:none;">
		...
		<table>
			...
			<tr><td>국제선 일반석 사전 좌석 배정 서비스</td>
			<td>O</td>
			<td>O</td>
			<td>O</td>
			<td>O</td>
			</tr>
			<tr><td>성수기 보너스 이용 시<br>평수기 공제 마일리지 적용</td>
			<td>O</td>
			<td>O</td>
			<td>O</td>
			<td>&nbsp;</td>
			</tr>
			<tr><td>보너스 항공권<br>재발행 수수료 면제</td>
			<td>O</td>
			<td>O</td>
			<td>O</td>
			<td>&nbsp;</td>
		...
		<div class="VIPinform">
			1) 춘식이 전용 짐부치는 곳을 이용할 수 있습니다.<br>
			2) 미주 노선 일반석은 제외 됩니다.<br>
