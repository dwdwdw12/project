	...
	<section class="p-5 tm-container-outer tm-bg-gray">
		...
		<div class="row">
			<div class="col-xs-12 mx-auto tm-about-text-wrap text-center">
				...
				<br>
				<h6>
					회원님의 계정은 현재 휴면 상태입니다.<br> 아래의 이메일 인증을 통해서 인증해주시기 바랍니다. 
				...
				<form name="signUpForm" method="post" id="emailInputForm">
					<table style="margin-left: auto; margin-right: auto;">
						<tr>
							<th
								style="padding: 8px; border-top: none; text-align: center; vertical-align: middle; width: 150px">이메일</th>
							<td style="border-top: none; padding: 0"><input type="text"
								name="email" id="email" maxlength="30" class="form-control"
